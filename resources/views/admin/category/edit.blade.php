            ...
            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-white border-0">
              <div class="rounded-t mb-0 px-6 py-6">
                <div class="text-center mb-3">
                  <h3 class="text-blueGray-500 text-2xl font-bold">Category Update</h3>
                </div>
              ...
              <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                <div class="text-blueGray-400 text-center mb-3 font-bold">
                    <small>changes will be applied on Category of ID : {{$category->id}}</small>
                </div>
                <form action="{{ route('category.update',$category) }}" method="POST">
                  ...
                  <div class="relative w-full mb-3">
                    ...
                    <input name="name" type="text" class="border-0 px-3 py-3 placeholder-blueGray-500 text-blueGray-600 bg-white rounded text-md shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Category name here..." value="{{ $category->name }}" />
                  </div>
                  <div class="relative w-full mb-3">
                    ...
                    <input name="slug" type="text" class="border-0 px-3 py-3 placeholder-blueGray-500 text-blueGray-600 bg-white rounded text-md shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Category slug here..." value="{{ $category->slug }}" />
                  </div>
